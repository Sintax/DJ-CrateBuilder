...
@pytest.mark.parametrize("cls,fields", [
    ...
    (DownloadPolicy, ("skip_existing", "skip_mode", "limit_enabled",
                      "limit_minutes", "bitrate_quality", "no_conversion",
